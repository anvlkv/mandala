...
// use euclid::default::{Point2D as Point, Size2D as Size, Vector2D};

// use crate::{Angle, Float, Path, Rect};
...
//     #[cfg(feature = "3d")]
//     let z = if bounds.z_range().is_empty() {
//         bounds.max.z
//     } else {
//         rng.gen_range(bounds.z_range())
//     };

//     cfg_if::cfg_if! { if #[cfg(feature = "3d")] {
//         crate::Point::new(x, y, z)
//     } else {
//         crate::Point::new(x, y)
//     }}
// }
...
// where
//     F: Fn(&mut R, Size<Float>) -> Path + Clone + Copy + 'static,
//     R: Rng + SeedableRng,
// {
//     /// Fill mode
...
//     Translate(FillValue<Vector2D<Float>>),
// }
